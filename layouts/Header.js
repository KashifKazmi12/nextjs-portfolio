...
import "@/public/assets/css/Components_styles/Header.css"
const Header = () => {
  const menus = [
    { id: 1, title: "Home", href: "home", icon: "fa fa-home" },
    { id: 2, title: "About", href: "about", icon: "fa fa-user" },
    { id: 3, title: "Services", href: "services", icon: "fa fa-suitcase" },
    ...
    >
      ...
      >
        {menus.map((menu) => (
          <li
            key={menu.id}
            className={`nav-icon desktop-nav-element cursor-pointer w-50 h-50 relative flex items-center transition duration-300 my-20 mx-0 rounded-full ${
              dark ? "bg-black-2" : "bg-light-grey"
          ...
          >
            ...
            />
            <div className="title group p-0 w-50 h-50">
